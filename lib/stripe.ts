...
export function checkoutConfigured() {
  return Boolean(runtimeEnv.STRIPE_SECRET_KEY && runtimeEnv.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY && runtimeEnv.STRIPE_PRICE_MONTHLY && runtimeEnv.STRIPE_INTRO_COUPON_ID);
}
